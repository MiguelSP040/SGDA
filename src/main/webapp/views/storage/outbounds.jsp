...
<% request.setAttribute("pageTitle", "Salidas"); %>
        ...
        <div class="card contenidoTotal shadow-lg p-5">
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content w-100">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="registerMovementLabel">Nueva Salida</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="registerOutboundMovementForm" method="post" action="/outbound/save">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div class="col me-2">
                                        <select class="form-select" name="storeKeeperName" required>
                                            <option value="" disabled selected>Seleccionar un área de destino
                                            </option>
                                ...
                                <div class="table-responsive table-container">
                                    <table class="table table-bordered table-striped text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 25%" class="tableTitle">Producto*</th>
                                            <th scope="col" style="width: 13%" class="tableTitle">Medida*</th>
                                            <th scope="col" style="width: 15%" class="tableTitle">Receptor*</th>
                                            <th scope="col" style="width: 5%" class="tableTitle">Precio*</th>
                                            <th scope="col" style="width: 10%" class="tableTitle">Cantidad*</th>
                                            <th scope="col" style="width: 10%" class="tableTitle">Precio total*</th>
                                        ...
                                        <tr>
                                            ...
                                            <td> <input class="form-control w-100" type="text" name="receiver"
                                                        placeholder="Receptor" required>
                                            </td>
                            ...
                            <form id="updateOutboundForm" method="post" action="/outbound/update">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="supplierName" class="form-label">Area de destino*</label>
                                            <select id="supplierName" class="form-select" required>
                                                <option value="" disabled selected>Seleccionar un area de destino
                                                </option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="price" class="form-label">Receptor*</label>
                                            <input class="form-control" type="text" name="quantity" min="0"
                                                   step="0.5" required>
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn botonCafe" id="updateEntryButton" onclick="updateOutbound()">
                                        Modificar
                                    </button>
                                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" onclick="reset()">
                                        Cancelar
            ...
            <div class="table-responsive table-container" id="contenedor">
                <table class="table table-bordered table-striped mt-0 text-center">
                    <thead class="thead-dark">
                    <tr>
                        <th scope="col" colspan="11" class="tableTitle">REPORTE DE SALIDAS
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button onclick="updateOutboundModal()" class="btn botonEditar" id="botonEditar"
                            ...
                            <button onclick="deleteOutbound()" class="btn botonRojo" id="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
