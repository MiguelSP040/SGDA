                ...
                <table class="table table-bordered table-striped mt-0 text-center">
                    ...
                    <c:forEach var="entry" items="${entries2}" varStatus="s">
                        <tr>
                            ...
                            <td>
                                <button class="btn botonVerMas" data-bs-toggle="modal" data-bs-target="#reviewEntryModal" onclick="loadProductDetails('${entry.folioNumber}','${entry.invoiceNumber}','${entry.providerName}','${entry.userName}','${entry.totalAllPrices}')" data-id="${entry.idEntry}">
