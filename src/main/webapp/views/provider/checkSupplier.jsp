                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="${pageContext.request.contextPath}/provider/delete" method="post" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn btn-lg botonRojo" onclick="return confirm('¿Estás seguro de que quieres cambiar el estado de este proveedor?');">
