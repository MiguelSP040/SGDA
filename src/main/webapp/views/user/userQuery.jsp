                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="newUserForm" method="post" action="/user/save">
                                ...
                                <div class="row">
                                    <div class="col"><input type="text" class="col-3 form-control" name="name" id="name" required>
                                    </div>
                                    <div class="col"><input type="text" class="form-control" name="surname" id="surname" required></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col"><input type="text" class="form-control" name="lastname" id="lastname" required></div>
                                    <div class="col"><input type="tel" class="form-control" name="phoneNumber" id="phone" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col"><input type="email" class="form-control" name="email" id="email" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn botonCafe" onclick="registerUser()">
                                        Registrar
                                    </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="updateUserForm" method="post" action="/user/update">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn botonCafe" onclick="updateUser()">
                                        Registrar
                                    </button>
                                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                        Cancelar
                ...
                <table class="table table-bordered table-striped mt-0 text-center" id="resultTable">
                    ...
                    <c:forEach var="user" items="${users}">
                        <tr>
                            ...
                            <td>
                                <button class="btn botonVerMas" id="botonVerMas" onsubmit="viewMore()"><svg
                                ...
                                <button onclick="update()" class="btn botonEditar" data-bs-toggle="modal"
                                ...
                                <button onclick="deleteUser()" class="btn botonRojo">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <tr>
                        <th scope="row">2</th>
                        <td>Danna Paola Sánchez Martínez</td>
                        <td>Administrador</td>
                        <td>20213TN039@utez.edu.mx</td>
                        <td>
                            <button class="btn statusRed w-100" id="statusInactivo">Inactivo</button>
                        </td>
                        <td>
                            ...
                            <button onclick="deleteUser()" class="btn btn-lg botonRojo">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                     fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                    <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5" />
                                </svg>
