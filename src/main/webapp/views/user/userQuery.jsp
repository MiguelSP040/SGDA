                        ...
                        <div class="modal-body">
                            <form id="updateUserForm" method="post" action="<%=context%>/user/update">
                                ...
                                <div class="row" style="text-indent: 2%!important;">
                                    ...
                                    <label for="u_lastname" class="col">Apellido paterno*</label>
                                </div>
                                <div class="row">
                                    <div class="col"><input type="text" class="col-3 form-control" id="u_name" name="name" required>
                                    </div>
                                    <div class="col"><input type="text" class="form-control" id="u_lastname" name="lastname"  required></div>
                                </div>
                                <div class="row" style="text-indent: 2%!important;">
                                    <label for="u_surname" class="col">Apellido materno*</label>
                                    <label class="col" for="u_phone">Teléfono*</label>
                                </div>
                                <div class="row">
                                    <div class="col"><input type="text" class="form-control" id="u_surname" name="surname"  required></div>
                                    <div class="col"><input type="tel" class="form-control" id="u_phone" name="phone"  required>
                                    </div>
                                </div>
                                <div class="row" style="text-indent: 2%!important;">
                                ...
                                <div class="row">
                                    <div class="col"><input type="email" class="form-control" id="u_email" name="email" required>
                                    </div>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="row" style="text-indent: 2%!important;">
                                    ...
                                    <label for="r_lastname" class="col">Apellido paterno</label>
                                </div>
                                <div class="row">
                                    <div class="col"><input type="text" class="form-control" id="r_name" name="name" readonly disabled>
                                    </div>
                                    <div class="col"><input type="text" class="form-control" id="r_lastname" name="lastname" readonly disabled></div>
                                </div>
                                <div class="row" style="text-indent: 2%!important;">
                                    <label for="r_surname" class="col">Apellido materno</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"><input type="tel" class="form-control" id="r_phone" name="phone"  readonly disabled>
                                    </div>
                                </div>
                                <div class="row" style="text-indent: 2%!important;">
                                ...
                                <div class="row">
                                    <div class="col"><input type="email" class="form-control" id="r_email" name="email" readonly disabled>
                                    </div>
                                </div>
                                <div class="row" style="text-indent: 2%!important;">
