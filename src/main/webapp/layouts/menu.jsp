...
<body>
<!--Seccion Banner-->
<div id="barraNavegacion" class="fixed-top">
    <nav class="navbar-expand-lg navbar-light navbar position">
        <!--    BOTOOON TOGGLE, realiza la funcion de ocultar y muestrar el menú lateral-->
        <div id="esconderBTN"><a>&#9776;</a></div>
        <div class="col-5" style="padding-left: 3%;">Consulta de usuarios</div>
        <div class="col-6" style="text-align: right;">Sistema Gestor de Almacén</div>
        <div class="col-1" style="text-align: right;padding-right: 4% ">
            <img src="../assets/img/logoSGDA.svg" loading="lazy" style="width: 80%; height: 80%;">
        </div>
    </nav>
</div>

<!--Seccion de Iconos de Menu lateral, sidebarCerrado*-->
<div id="sidebarCerrado" style="margin-top: 3%;">
    ...
    <a id="userLogged" class="user-logged">
...
<!--Seccion Menu lateral extendido, contiene submenu, sidebarAbierto*-->
<div id="sidebarAbierto" style="margin-top: 3%;">
    ...
    <div class="submenu">
        ...
        <a href="#">Movimientos</a> <!--Entradas/Salidas-->
    ...
    <!--Submenu de Almacen-->
    <div class="submenu">
        <a href="#">Registro de Movimientos</a>
        <a href="#">Reporte de Movimientos</a>
        <a href="#">Áreas destino</a>
    </div>
    <!--Usuarios-->
    <a class="dropdown-btn">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
